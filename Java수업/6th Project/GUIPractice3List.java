...
public class GUIPractice3List extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("저장하기")) { //이벤트가 일어난 객체의 getText()
			...
			String str = list.getText(); // 전체 텍스트
			...
			*/
			...
			if(cnt!=0){ //중복된 숫자여도 내용이 수정되면 저장가능함
				...
				try {
					...
					pw.println(list.getSelectedValue()+"");
